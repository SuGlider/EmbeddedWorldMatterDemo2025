...
//
// This Matter Application will create 1 endpoint: Color RGB+CWW Dimmable Light
// It uses a device with 3 WS2812 LEDs (M5Stack RGB LED Unit)
// WiFi will connect automatically using last NVS stored credentials
// In case it fails, it will try to connect using hardcoded WiFi credential (defined in this code)
...
#define LIGHT_PIN  (0)   // Use 0, 3, 5, 6
